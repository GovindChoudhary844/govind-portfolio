...
import "../../../App.css";
import Project1Desktop from "../../Components/ProjectScreenComponent/Project1Desktop";
import Project1Tablet from "../../Components/ProjectScreenComponent/Project1Tablet";
import Project1Mobile from "../../Components/ProjectScreenComponent/Project1Mobile";

function OrganicFruitsWebsite() {
  ...
  return (
    <>
      ...
      >
        <h1 className="page-title resp-h1 text-center">
...
export default OrganicFruitsWebsite;
